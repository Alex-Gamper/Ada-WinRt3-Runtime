...
void
__gnat_os_filename (char *filename,
		    char *w_filename,
...
int
__gnat_is_symbolic_link_attr (char* name,
                              struct file_attributes* attr)
{
...
int
__gnat_to_canonical_file_list_init (char *dirspec,
				    int onlydirs)
{
  return 0;
}
